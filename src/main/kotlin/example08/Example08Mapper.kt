...
interface Example08Mapper {
    ...
    @ConstructorArgs(value = [
        ...
        Arg(resultMap = "PersonResultAnnotated", javaType = List::class)
    ])
    fun selectAddressByIdAnnotated(id: Int): AddressWithPeople

    @Results(id = "PersonResultAnnotated")
    @ConstructorArgs(value = [
    ...
    @Select("dummy")
    fun dummyPersonResult() : List<Person>
